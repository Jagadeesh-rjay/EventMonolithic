...
import com.rjay.user.exception.UserNotFoundException;
import com.rjay.user.exception.UserSaveFailedException;
import com.rjay.user.service.AddressService;
...
import com.rjay.user.utility.Constants.UserStatus;
...
public class UserResource {
	...
	public ResponseEntity<CommonResponseAPI> registerUser(RegisterUserDTO register) {
		...
		if ("user".equalsIgnoreCase(register.getRole())) {
			...
			user.setAddress(savedAddress);
			//user.setEventOrganizationName(register.getEventOrganizationName());
